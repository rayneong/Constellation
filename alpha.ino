...
//  delay(500);
  ...
  if (sensorValue > 400) {
    ...
    tone(speakerPin,notes[sizeof(notes)/sizeof(int) - i],wait);
  }
  delay(wait);
  i = (i + 1) % (sizeof(notes)/sizeof(int));
  Serial.println(sensorValue);

//  int wait = beats1[i] * songspeed;
//  if (sensorValue > 400) {
//    tone(speakerPin,melody1[i],wait);          //tone(pin,frequency,duration)
//  } else {
//    tone(speakerPin,melody1[sizeof(notes)/sizeof(int) - i],wait);
//  }
//  delay(wait);
//  i = (i + 1) % (sizeof(melody1)/sizeof(int));
//  Serial.println(sensorValue);
}
